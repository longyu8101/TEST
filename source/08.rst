...
.. raw:: html
 ...
 <p><a href="#id8.1.3"> 8.1.3</a> <span id="id8.1.3">防波堤结构基本情况调查应满足第<a href="https://jts304-2019.readthedocs.io/zh/latest/03.html#id3.0.2">3.0.2</a>条的规定。</span></p>
...
.. raw:: html
 ...
 <p><a href="#id8.1.9"> 8.1.9</a> <span id="id8.1.9">桩基透空式防波堤的检测可参照第7.4节的有关规定进行，半圆体型、沉箱墩透空式等其他结构型式的防波堤检测可参照第<a href="#id8.1.4">8.1.4</a>条~第<a href="#id8.1.7">8.1.7</a>条的规定进行。</span></p>
...
.. raw:: html
 ...
 <p><a href="#id8.2.1"> 8.2.1</a> <span id="id8.2.1">防波堤安全性、适用性和耐久性评估的确定应按第<a href="https://jts304-2019.readthedocs.io/zh/latest/03.html#id3.0.4">3.0.4</a>条的规定执行。
      ...
      #dhbg{
		...
		<table id="biaoge" style="font-family:times new roman">
         ...
         <caption style="caption-side:top;text-align: center;color:black" ><b style="text-align:center"> <div id="B8.2.2">表8.2.2 防波堤安全性评估分级标准</b></caption>	
		    ...
		    <tr>
		        <td align="center" colspan="3" rowspan="2"id="dhbg">项目</td>
                <!-- <td></td> -->
                <!-- <td></td> -->
            ...
            <tr>
                ...
                <!-- <td></td> -->
                <!-- <td></td> -->
                <td align="center"width="170px">A</td>
                <td align="center"width="250px">B</td>
                <td  align="center"width="250px">C</td>
                <td align="center"width="170px">D</td>
		    </tr>


		   <tr>
           	<td width="40px"  align="center" rowspan="3"id="dhbg"> 斜坡式</td>
		      <td align="left" colspan="2">栅栏般的承载能力</td>
		        <!-- <td></td> -->
               <td  align="center" rowspan="2"id="dhbg"><i>R</i><sub>d</sub>/(<i>γ</i><sub>0</sub><i>S</i><sub>d</sub>)≥1.00</td>
               <td  align="center" rowspan="2"id="dhbg">0.90≤<i>R</i><sub>d</sub>/(<i>γ</i><sub>0</sub><i>S</i><sub>d</sub>)< 1.00</td>
               <td align="center" rowspan="2"id="dhbg">0.85≤<i>R</i><sub>d</sub>/(<i>γ</i><sub>0</sub><i>S</i><sub>d</sub>)< 0.90</td>
		         <td align="center" rowspan="2"id="dhbg"><i>R</i><sub>d</sub>/(<i>γ</i><sub>0</sub><i>S</i><sub>d</sub>)< 0.85 </td>
         </tr>

         <tr>

		      <td  align="left" colspan="2">胸墙的承载能力</td>
         ...
         <tr>
	       ...
	       <tr>
           	  <td  width="40px" align="center" rowspan="4"id="dhbg"> 直立式</td>
         ...
         <tr>
           ...
           <tr>
		        ...
		        <td width="70px" align="center" rowspan="1"id="dhbg">沉箱、扶壁、方块、圆筒&emsp;</td>
		         <td  align="center" id="dhbg"><i>R</i><sub>d</sub>/(<i>γ</i><sub>0</sub><i>S</i><sub>d</sub>)≥1.00</td>
           ...
           <tr>
              <td align="center" rowspan="2"id="dhbg"> 直立式 </td>
              <td align="left" colspan="2"> 基床和地基承载能力</td>
              <!-- <td></td> -->
              <td  align="center" id="dhbg"><i>R</i><sub>d</sub>/(<i>γ</i><sub>0</sub><i>S</i><sub>d</sub>)≥1.00</td>
              <td  align="center" id="dhbg">0.95≤<i>R</i><sub>d</sub>/(<i>γ</i><sub>0</sub><i>S</i><sub>d</sub>)< 1.00</td>
              <td  align="center" id="dhbg">0.90≤<i>R</i><sub>d</sub>/(<i>γ</i><sub>0</sub><i>S</i><sub>d</sub>)< 0.95</td>
 ...
 <p><a href="#id8.2.3"> 8.2.3</a> <span id="id8.2.3"> 防波堤的适用性应根据检测结果按<a href="#B8.2.3">表8.2.3</a>的规定进行评估。</span></p>
		...
		<table id="biaoge" style="font-family:times new roman">
         ...
         <caption style="caption-side:top;text-align: center;color:black" ><b style="text-align:center"> <div id="B8.2.3">表8.2.3 防波堤适用性评估分级标准</b></caption>	
		   ...
		   <tr>
		        <td  align="center" id="dhbg">分级<br/>标准</td>
		        <td  align="left" >防波堤断面无变化或变化不大，对港内泊稳没影响</td>
                <td  align="left" >防波堤断面略有变化，对港内泊稳略有影响</td>
                <td  align="left" >防波堤断面变化较大，对港内泊稳影响较大</td>
		        <td  align="left" >防波堤断面变化很大，对港内泊稳影响很大 </td>
            </tr>
     	 </table>
...
.. raw:: html
    ...
    <p><a href="#id8.2.4"> 8.2.4</a> <span id="id8.2.4"> 防波堤混凝土结构耐久性评估应按<a href="https://jts304-2019.readthedocs.io/zh/latest/04.html">第4章</a>的有关规定执行。</span></p>